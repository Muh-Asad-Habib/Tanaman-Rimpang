...
export default function Guide() {
  return <main id="konten" className="container page-main"><div className="page-heading"><p className="eyebrow">SEBELUM MULAI</p><h1>Kenali dengan tenang.<br /><em>Mulai dengan yang sederhana.</em></h1><p>Sedikit persiapan membuat rimpang lebih mudah dilihat dan dipelajari.</p></div>
